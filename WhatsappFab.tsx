    ...
    <>
      <div className="fixed bottom-6 right-6 flex flex-col-reverse items-end gap-3 z-40">
        ...
        {showOptions && (
          <div className="flex flex-col gap-3 animate-in slide-in-from-bottom-2 duration-200">
            ...
            <div className="flex items-center gap-3">
              <span className="bg-white px-3 py-1 rounded-lg shadow-md text-sm font-medium text-gray-700">
                Quick Chat
              </span>
              <button
                onClick={toggleChat}
        ...
        <button
          ...
          className="bg-gradient-to-r from-green-500 to-blue-500 hover:from-green-600 hover:to-blue-600 text-white p-4 rounded-full shadow-lg transition-all duration-300 hover:scale-110"
          aria-label="Contact Options"
        >
          {showOptions ? (
            <svg className="h-6 w-6 transform rotate-45" fill="none" stroke="currentColor" viewBox="0 0 24 24">
